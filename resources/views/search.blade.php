        ...
        <div class="row g-9 g-lg-0 align-items-center py-12 py-sm-20">
            <div class="col-lg-6 pe-4 pe-md-10">
                <div class="d-grid gap-4 gap-md-6 position-relative cus-z1">
                    <h2 class="display-four n17-color">Search Results</h2>
                    <div class="breadcrumb-area">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb second position-relative m-0 d-center justify-content-start gap-2 gap-md-3">
                                ...
                                <li class="breadcrumb-item d-flex align-items-center fs-seven active" aria-current="page"><span class="fw-mid f5-color">Search</span></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-lg-6 pe-4 pe-md-10 d-none d-md-flex">
                <div class="img-area position-absolute end-0 bottom-0">
                    <img src="{{ asset('assets/images/banner-illus-16.png') }}" alt="img">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xxl-12 cus-z1">
                <div class="row cus-row top-stores trending-features g-3">
                    ...
                    <div class="col-6 col-sm-4 col-lg-3 col-xxl-2">
                        <a href="{{ route('coupons.index', ['category' => $coupon->category->slug]) }}" class="single-box transition d-grid gap-3 gap-md-4 text-center n1-bg-color cus-border border b-seventh px-2 px-xxl-3 py-4 py-xxl-6 rounded-2">
                            <div class="d-center thumb-area rounded-2 w-100">
                                <img class="max-un" src="{{ asset($coupon->image) }}" alt="Image">
                            </div>
                            <div class="text-area">
                                <span class="n17-color fs-five fw-mid">{{ $coupon->title }}</span>
                            </div>
                        </a>
                    </div>
                    @empty
